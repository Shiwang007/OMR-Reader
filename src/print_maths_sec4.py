...
maths_sec4_r = [p for p in circles if 570 < p[0] < 770 and 3000 < p[1] < 3150]
maths_sec4_r.sort(key=lambda p: (p[1], p[0]))

print(f"Maths Sec 4 Right points ({len(maths_sec4_r)}):")
for p in maths_sec4_r:
