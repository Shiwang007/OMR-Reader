...
DATA_DIR = os.path.join(BASE_DIR, "data", "jee")
ANSWER_KEY_PATH = os.path.join(BASE_DIR, "answer", "11_jee.json")
REPORT_TEMPLATE_PATH = os.path.join(BASE_DIR, "templates", "jee_report_template.html")
...
OUTPUT_DIR = os.path.join(BASE_DIR, "output", "AKAAR_JEE")
...
def generate_reports():
    ...
    for filename in files:
        ...
        html = html.replace("{{EXAM_NAME}}", "AKAAR JEE")
        ...
        leaderboard_data.append({
            ...
            "maths": subj_stats["Mathematics"]["score"],
    ...
    for i, s in enumerate(leaderboard_data):
        pct = f"{(s['total_score']/300*100):.1f}%"
        rows_html += f"""<tr>
    ...
    print(f"Success! Reports and leaderboard generated in {OUTPUT_DIR}")
